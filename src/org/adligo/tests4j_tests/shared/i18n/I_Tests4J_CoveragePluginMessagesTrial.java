...
@SourceFileScope (sourceClass=I_Tests4J_CoveragePluginMessages.class, minCoverage=100.0)
@AllowedReferences (groups=Tests4J_I18N_GwtReferenceGroup.class)
public class I_Tests4J_CoveragePluginMessagesTrial extends SourceFileCountingTrial {
