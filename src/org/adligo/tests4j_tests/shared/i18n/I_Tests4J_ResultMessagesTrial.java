...
@SourceFileScope (sourceClass=I_Tests4J_ResultMessages.class, minCoverage=100.0)
@AllowedDependencies (groups=Tests4J_I18N_DependencyGroup.class)
public class I_Tests4J_ResultMessagesTrial extends SourceFileCountingTrial {
