...
@SourceFileScope (sourceClass=SystemWithPrintStreamDelegate.class, minCoverage=0.0)
@AllowedDependencies (groups=Tests4J_Common_DependencyGroup.class)
public class SystemWithPrintStreamDelegateTrial extends SourceFileCountingTrial {
