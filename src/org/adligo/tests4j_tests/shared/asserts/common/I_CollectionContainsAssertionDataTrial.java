...
@SourceFileScope (sourceClass=I_CollectionContainsAssertionData.class)
@AllowedDependencies (groups=Tests4J_AssertsCommon_DependencyGroup.class)
public class I_CollectionContainsAssertionDataTrial extends SourceFileCountingTrial {
