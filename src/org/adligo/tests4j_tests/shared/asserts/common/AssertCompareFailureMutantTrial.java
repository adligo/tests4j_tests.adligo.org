...
@SourceFileScope (sourceClass=AssertCompareFailureMutant.class, minCoverage=0)
@AllowedDependencies (groups=Tests4J_AssertsCommon_DependencyGroup.class)
public class AssertCompareFailureMutantTrial extends SourceFileCountingTrial {
