...
@SourceFileScope (sourceClass=ReferenceGroupMutant.class, minCoverage=92.0)
@AllowedReferences (groups=Tests4J_AssertsReference_GwtReferenceGroup.class)
public class ReferenceGroupMutantTrial extends SourceFileCountingTrial {
	...
	public void assertBasic(ReferenceGroupMutant dgm) {
	...
	public void assertBasicMethod(ReferenceGroupMutant dgm) {
	...
	public void assertBasicField(ReferenceGroupMutant dgm) {
