...
public class NoUseCaseAnnotationTrial extends UseCaseTrial {
  ...
  public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals("org.adligo.tests4j_tests.trials_api.bad_mock_use_case_trials.NoUseCaseAnnotationTrial", 
		...
		asserts.assertEquals("UseCaseTrials must be annotated with @UseCaseScope.", failure.getMessage());
