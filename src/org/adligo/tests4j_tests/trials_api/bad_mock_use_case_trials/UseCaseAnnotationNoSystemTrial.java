...
public class UseCaseAnnotationNoSystemTrial extends UseCaseTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals("org.adligo.tests4j_tests.trials_api.bad_mock_use_case_trials.UseCaseAnnotationNoSystemTrial", 
		...
		asserts.assertEquals("@UseCaseScope annotations must contain a non empty system.", failure.getMessage());
