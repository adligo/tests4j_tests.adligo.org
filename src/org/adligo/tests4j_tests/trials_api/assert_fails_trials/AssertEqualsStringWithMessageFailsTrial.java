...
public class AssertEqualsStringWithMessageFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception  {
		...
		asserts.assertEquals(AssertEqualsStringWithMessageFailsTrial.class.getName(), topElement.getClassName());
