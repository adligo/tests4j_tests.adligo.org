...
public class AssertNotSameFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(new Tests4J_AssertionResultMessages().getTheObjectsShould_NOT_BeTheSame(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertNotSameFailsTrial.class.getName(), topElement.getClassName());
