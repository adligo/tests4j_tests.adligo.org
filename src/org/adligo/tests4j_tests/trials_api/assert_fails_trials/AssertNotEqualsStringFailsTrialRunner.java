...
public class AssertNotEqualsStringFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotEqualsStringFailsTrial.class);
		...
		asserts.assertEquals(AssertNotEqualsStringFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAssertNotEquals", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertNotEquals", testResult.getName());
		...
		asserts.assertEquals(messages.getTheObjectsShould_NOT_BeEqual(), testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertNotEqualsStringFailsTrial.testAssertNotEquals(AssertNotEqualsStringFailsTrial.java:14)", lines.getLine(1));
