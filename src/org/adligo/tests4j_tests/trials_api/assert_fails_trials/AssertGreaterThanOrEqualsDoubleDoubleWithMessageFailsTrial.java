...
public class AssertGreaterThanOrEqualsDoubleDoubleWithMessageFailsTrial extends ApiTrial {

	public static final String TEST_ASSERT_FAILS_MESSAGE = "testAsserGreaterThanEqualsDoubleDoubleFailsWithMessage message";

	@Test
	public void testAsserGreaterThanEqualsDoubleDoubleFailsWithMessage() {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleDoubleWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleDoubleFailsWithMessage", testMeta.getTestName());
		...
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleDoubleFailsWithMessage", testResult.getName());
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleDoubleWithMessageFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleDoubleFailsWithMessage", topElement.getMethodName());
