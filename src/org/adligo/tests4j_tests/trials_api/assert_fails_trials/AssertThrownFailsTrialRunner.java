...
public class AssertThrownFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertThrownFailsTrial.class);
		...
		asserts.assertEquals(AssertThrownFailsTrial.class.getName(), 
		...
		asserts.assertEquals(messages.getTheExpectedThrowableDidNotMatch(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertThrownFailsTrial.testAssertThrown(AssertThrownFailsTrial.java:18)", lines.getLine(1));
