...
public class AssertThrownUniformWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertThrownUniformWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertThrownUniformWithMessageFailsTrial.testAssertThrownUniformWithMessage(AssertThrownUniformWithMessageFailsTrial.java:20)", lines.getLine(1));
