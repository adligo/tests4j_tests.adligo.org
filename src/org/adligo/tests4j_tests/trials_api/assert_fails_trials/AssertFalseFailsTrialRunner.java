...
public class AssertFalseFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertFalseFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertFalseFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(messages.getTheValueShouldBeFalse(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertFalseFailsTrialRunner.class.getName(), topElement.getClassName());
