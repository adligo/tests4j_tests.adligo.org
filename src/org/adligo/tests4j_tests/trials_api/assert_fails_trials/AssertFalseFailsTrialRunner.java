...
public class AssertFalseFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(messages.getTheValueShouldBeFalse(), testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertFalseFailsTrial.testAssertFalseIsTrue(AssertFalseFailsTrial.java:14)", lines.getLine(1));
