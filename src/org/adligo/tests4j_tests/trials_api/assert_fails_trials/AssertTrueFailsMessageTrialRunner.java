...
public class AssertTrueFailsMessageTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals("testAssertTrueIsFalseWithMessage", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertTrueIsFalseWithMessage", testResult.getName());
		...
		asserts.assertEquals(AssertTrueFailsMessageTrial.TRUE_IS_FALSE_MESSAGE, testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertTrueFailsMessageTrial.testAssertTrueIsFalseWithMessage(AssertTrueFailsMessageTrial.java:16)", lines.getLine(1));
