...
public class AssertGreaterThanOrEqualsDoubleIntWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleIntWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleIntFailsWithMessage", testMeta.getTestName());
		...
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleIntFailsWithMessage", testResult.getName());
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleIntWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE,
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertGreaterThanOrEqualsDoubleIntWithMessageFailsTrial.testAsserGreaterThanEqualsDoubleIntFailsWithMessage(AssertGreaterThanOrEqualsDoubleIntWithMessageFailsTrial.java:17)", lines.getLine(1));
