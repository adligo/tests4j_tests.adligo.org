...
public class AssertNotEqualsWithMessageFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotEqualsWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertNotEqualsWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAssertNotEqualsWithMessage", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertNotEqualsWithMessage", testResult.getName());
		...
		asserts.assertEquals(AssertNotEqualsWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertNotEqualsWithMessageFailsTrial.testAssertNotEqualsWithMessage(AssertNotEqualsWithMessageFailsTrial.java:16)", lines.getLine(1));
