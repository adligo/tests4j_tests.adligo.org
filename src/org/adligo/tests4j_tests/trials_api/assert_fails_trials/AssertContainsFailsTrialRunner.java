...
public class AssertContainsFailsTrialRunner  {

	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertContainsFailsTrial.class);
		...
		asserts.assertEquals(AssertContainsFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAssertContainsFails", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertContainsFails", testResult.getName());
		...
		asserts.assertEquals(messages.getTheCollectionShouldContainTheValue(), testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertContainsFailsTrial.testAssertContainsFails(AssertContainsFailsTrial.java:18)", lines.getLine(1));
