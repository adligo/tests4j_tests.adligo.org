...
public class AssertGreaterThanOrEqualsDoubleShortFailsTrial extends ApiTrial {

	@Test
	public void testAssertGreaterThanEqualsFailsDoubleShort() {
		assertGreaterThanOrEquals(1.0, (short) 0);
	}
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertGreaterThanOrEqualsDoubleShortFailsTrial.class);
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleShortFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAssertGreaterThanEqualsFailsDoubleShort", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertGreaterThanEqualsFailsDoubleShort", testResult.getName());
		...
		asserts.assertEquals(new Tests4J_AssertionResultMessages().getTheActualShouldBeGreaterThanOrEqualToTheExpected(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleShortFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertGreaterThanEqualsFailsDoubleShort", topElement.getMethodName());
