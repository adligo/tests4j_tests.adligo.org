...
public class AssertGreaterThanOrEqualsDoubleLongFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleLongFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertGreaterThanEqualsFailsDoubleLong", topElement.getMethodName());
