...
public class AssertSameFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertSameFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertSameFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(messages.getTheObjectsShouldBeTheSame(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertSameFailsTrialRunner.class.getName(), topElement.getClassName());
