...
public class AssertSameFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(messages.getTheObjectsShouldBeTheSame(), testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertSameFailsTrial.testAssertSame(AssertSameFailsTrial.java:14)", lines.getLine(1));
