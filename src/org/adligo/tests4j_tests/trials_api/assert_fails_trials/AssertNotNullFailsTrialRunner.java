...
public class AssertNotNullFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(messages.getTheValueShould_NOT_BeNull(), testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertNotNullFailsTrial.testAssertNotNull(AssertNotNullFailsTrial.java:14)", lines.getLine(1));
