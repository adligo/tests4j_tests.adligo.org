...
public class AssertNotNullFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertNotNullFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertNotNullFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(messages.getTheValueShould_NOT_BeNull(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertNotNullFailsTrialRunner.class.getName(), topElement.getClassName());
