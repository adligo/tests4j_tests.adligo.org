...
public class AssertSameWithMessageFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertSameWithMessageFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertSameWithMessageFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(AssertSameWithMessageFailsTrialRunner.class.getName(), topElement.getClassName());
