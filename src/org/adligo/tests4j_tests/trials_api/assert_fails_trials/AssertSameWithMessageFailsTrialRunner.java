...
public class AssertSameWithMessageFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertSameWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertSameWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals(AssertSameWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertSameWithMessageFailsTrial.testAssertSameWithMessage(AssertSameWithMessageFailsTrial.java:16)", lines.getLine(1));
