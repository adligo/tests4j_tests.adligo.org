...
public class AssertSameWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertSameWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, testFailure.getMessage());
		...
		asserts.assertEquals(AssertSameWithMessageFailsTrial.class.getName(), topElement.getClassName());
