...
public class AssertEqualsWithMessageFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception  {
		...
		runner.run(AssertEqualsWithMessageFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertEqualsWithMessageFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(AssertEqualsWithMessageFailsTrialRunner.class.getName(), topElement.getClassName());
