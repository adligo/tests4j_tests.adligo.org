...
public class AssertEqualsWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception  {
		...
		asserts.assertEquals(AssertEqualsWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertEqualsWithMessageFailsTrial.testAssertEqualsFailsWithMessage(AssertEqualsWithMessageFailsTrial.java:16)", lines.getLine(1));
