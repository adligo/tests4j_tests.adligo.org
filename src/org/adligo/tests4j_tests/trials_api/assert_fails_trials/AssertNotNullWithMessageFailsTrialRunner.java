...
public class AssertNotNullWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals("testAssertNotNullWithMessage", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertNotNullWithMessage", testResult.getName());
		...
		asserts.assertEquals(AssertNotNullWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertNotNullWithMessageFailsTrial.testAssertNotNullWithMessage(AssertNotNullWithMessageFailsTrial.java:16)", lines.getLine(1));
