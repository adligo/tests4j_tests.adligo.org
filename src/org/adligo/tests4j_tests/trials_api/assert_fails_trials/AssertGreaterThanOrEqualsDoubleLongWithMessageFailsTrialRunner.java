...
public class AssertGreaterThanOrEqualsDoubleLongWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts) throws Exception  {
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleLongWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, testFailure.getMessage());
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleLongWithMessageFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleLongFailsWithMessage", topElement.getMethodName());
