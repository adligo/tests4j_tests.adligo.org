...
public class AssertNullWithMessageFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		asserts.assertEquals(AssertNullWithMessageFailsTrial.class.getName(), topElement.getClassName());
