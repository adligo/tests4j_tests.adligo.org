...
public class AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, testFailure.getMessage());
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleShortFailsWithMessage", topElement.getMethodName());
