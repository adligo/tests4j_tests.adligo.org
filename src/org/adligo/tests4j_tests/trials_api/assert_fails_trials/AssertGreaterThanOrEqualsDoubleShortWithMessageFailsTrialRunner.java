...
public class AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrialRunner {
  ...
  public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials."
		    + "AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrial."
		    + "testAsserGreaterThanEqualsDoubleShortFailsWithMessage("
		    + "AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrial.java:16)", lines.getLine(1));
