...
public class AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrial.class);
		...
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleShortFailsWithMessage", testMeta.getTestName());
		...
		asserts.assertEquals("testAsserGreaterThanEqualsDoubleShortFailsWithMessage", testResult.getName());
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrial.testAsserGreaterThanEqualsDoubleShortFailsWithMessage(AssertGreaterThanOrEqualsDoubleShortWithMessageFailsTrial.java:16)", lines.getLine(1));
