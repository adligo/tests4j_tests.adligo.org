...
public class AssertUniformWithMessageFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertUniformWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertUniformWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals(AssertUniformWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertUniformWithMessageFailsTrial.testAssertUniformWithMessage(AssertUniformWithMessageFailsTrial.java:16)", lines.getLine(1));
