...
public class AssertNotEqualsStringFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(new Tests4J_AssertionResultMessages().getTheObjectsShould_NOT_BeEqual(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertNotEqualsStringFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertNotEquals", topElement.getMethodName());
