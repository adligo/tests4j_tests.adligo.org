...
public class AssertNullFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertNullFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertNullFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals("testAssertNull", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertNull", testResult.getName());
		...
		asserts.assertEquals(messages.getTheValueShouldBeNull(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertNullFailsTrialRunner.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertNull", topElement.getMethodName());
