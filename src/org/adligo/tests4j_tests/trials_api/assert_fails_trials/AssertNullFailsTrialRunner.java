...
public class AssertNullFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertNullFailsTrial.class.getName(), 
		...
		asserts.assertEquals(messages.getTheValueShouldBeNull(), testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertNullFailsTrial.testAssertNull(AssertNullFailsTrial.java:14)", lines.getLine(1));
