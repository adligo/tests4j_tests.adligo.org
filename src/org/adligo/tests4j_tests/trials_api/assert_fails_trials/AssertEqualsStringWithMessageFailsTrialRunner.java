...
public class AssertEqualsStringWithMessageFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception  {
		...
		runner.run(AssertEqualsStringWithMessageFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertEqualsStringWithMessageFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(AssertEqualsStringWithMessageFailsTrialRunner.class.getName(), topElement.getClassName());
