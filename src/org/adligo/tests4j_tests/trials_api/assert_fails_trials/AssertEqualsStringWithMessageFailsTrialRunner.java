...
public class AssertEqualsStringWithMessageFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception  {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertEqualsStringWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertEqualsStringWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals(AssertEqualsStringWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertEqualsStringWithMessageFailsTrial.testAssertEqualsFailsWithMessage(AssertEqualsStringWithMessageFailsTrial.java:16)", lines.getLine(1));
