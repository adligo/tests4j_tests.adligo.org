...
public class AssertNotUniformFailsTrialRunner {
  ...
  public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(messages.getTheObjectsShould_NOT_BeUniform(), testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials."
		    + "AssertNotUniformFailsTrial.testAssertNotUniform(AssertNotUniformFailsTrial.java:14)", lines.getLine(1));
