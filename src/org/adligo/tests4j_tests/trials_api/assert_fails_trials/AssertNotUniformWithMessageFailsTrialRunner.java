...
public class AssertNotUniformWithMessageFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotUniformWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertNotUniformWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals(AssertNotUniformWithMessageFailsTrial.TEST_ASSERT_FAILS_MESSAGE, 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertNotUniformWithMessageFailsTrial.testAssertNotUniformWithMessage(AssertNotUniformWithMessageFailsTrial.java:16)", lines.getLine(1));
