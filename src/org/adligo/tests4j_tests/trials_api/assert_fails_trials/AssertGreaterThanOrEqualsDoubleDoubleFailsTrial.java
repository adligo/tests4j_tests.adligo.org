...
public class AssertGreaterThanOrEqualsDoubleDoubleFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleDoubleFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertGreaterThanEqualsFailsDoubleDouble", topElement.getMethodName());
