...
public class AssertNotSameFailsTrialRunner {
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotSameFailsTrial.class);
		...
		asserts.assertEquals(AssertNotSameFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAssertNotSame", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertNotSame", testResult.getName());
		...
		asserts.assertEquals(messages.getTheObjectsShould_NOT_BeTheSame(), testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertNotSameFailsTrial.testAssertNotSame(AssertNotSameFailsTrial.java:14)", lines.getLine(1));
