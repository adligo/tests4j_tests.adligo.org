...
public class AssertNotSameFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertNotSameFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertNotSameFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(messages.getTheObjectsShould_NOT_BeTheSame(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertNotSameFailsTrialRunner.class.getName(), topElement.getClassName());
