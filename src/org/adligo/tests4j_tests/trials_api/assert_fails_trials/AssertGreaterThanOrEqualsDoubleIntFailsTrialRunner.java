...
public class AssertGreaterThanOrEqualsDoubleIntFailsTrialRunner {
  ...
  public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials."
		    + "AssertGreaterThanOrEqualsDoubleIntFailsTrial.testAssertGreaterThanEqualsFailsIntFloat("
		    + "AssertGreaterThanOrEqualsDoubleIntFailsTrial.java:14)", lines.getLine(1));
