...
public class AssertThrownWithMessageFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertThrownWithMessageFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertThrownWithMessageFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(AssertThrownWithMessageFailsTrialRunner.class.getName(), topElement.getClassName());
