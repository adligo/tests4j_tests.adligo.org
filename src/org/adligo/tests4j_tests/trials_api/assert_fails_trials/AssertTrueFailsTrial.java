...
public class AssertTrueFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(new Tests4J_AssertionResultMessages().getTheValueShouldBeTrue(), testFailure.getMessage());
