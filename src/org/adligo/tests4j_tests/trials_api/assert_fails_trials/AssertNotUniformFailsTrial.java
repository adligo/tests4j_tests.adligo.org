...
public class AssertNotUniformFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		asserts.assertEquals(new Tests4J_AssertionResultMessages().getTheObjectsShould_NOT_BeUniform(), testFailure.getMessage());
