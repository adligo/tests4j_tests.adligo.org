...
public class AssertGreaterThanOrEqualsDoubleFloatFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertGreaterThanOrEqualsDoubleFloatFailsTrial.class);
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleFloatFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAssertGreaterThanEqualsFailsDoubleFloat", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertGreaterThanEqualsFailsDoubleFloat", testResult.getName());
		...
		asserts.assertEquals(messages.getTheActualShouldBeGreaterThanOrEqualToTheExpected(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertGreaterThanOrEqualsDoubleFloatFailsTrial.testAssertGreaterThanEqualsFailsDoubleFloat(AssertGreaterThanOrEqualsDoubleFloatFailsTrial.java:14)", lines.getLine(1));
