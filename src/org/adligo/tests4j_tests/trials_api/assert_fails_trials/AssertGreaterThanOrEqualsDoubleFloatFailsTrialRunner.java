...
public class AssertGreaterThanOrEqualsDoubleFloatFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertGreaterThanOrEqualsDoubleFloatFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertGreaterThanEqualsFailsDoubleFloat", topElement.getMethodName());
