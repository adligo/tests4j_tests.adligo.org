...
public class AssertEqualsFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertEqualsFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertEqualsFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals(AssertEqualsFailsTrialRunner.class.getName(), topElement.getClassName());
