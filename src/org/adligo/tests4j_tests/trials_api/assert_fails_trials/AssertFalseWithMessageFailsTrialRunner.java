...
public class AssertFalseWithMessageFailsTrialRunner {
  ...
  public static void runTestDelegate(I_Asserts asserts)  throws Exception  {
		...
		asserts.assertEquals(AssertFalseWithMessageFailsTrial.FALSE_IS_TRUE_MESSAGE, testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials."
		    + "AssertFalseWithMessageFailsTrial.testAssertFalseIsTrueWithMessage("
		    + "AssertFalseWithMessageFailsTrial.java:16)", lines.getLine(1));
