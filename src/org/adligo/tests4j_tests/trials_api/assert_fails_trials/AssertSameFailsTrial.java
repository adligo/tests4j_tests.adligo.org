...
public class AssertSameFailsTrial extends ApiTrial {

	@Test
	public void testAssertSame() {
		assertSame(this, new Object());
	}
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertSameFailsTrial.class);
		...
		asserts.assertEquals(AssertSameFailsTrial.class.getName(), 
		...
		asserts.assertEquals("testAssertSame", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertSame", testResult.getName());
		...
		asserts.assertEquals(new Tests4J_AssertionResultMessages().getTheObjectsShouldBeTheSame(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertSameFailsTrial.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertSame", topElement.getMethodName());
