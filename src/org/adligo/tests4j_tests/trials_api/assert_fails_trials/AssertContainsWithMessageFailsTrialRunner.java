...
public class AssertContainsWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts) throws Exception  {
		...
		asserts.assertEquals(AssertContainsWithMessageFailsTrial.TEST_ASSERT_CONTAINS_FAILS_MESSAGE, testFailure.getFailureMessage());
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertContainsWithMessageFailsTrial.testAssertContainsFailsWithMessage(AssertContainsWithMessageFailsTrial.java:20)", lines.getLine(1));
