...
public class AssertNotEqualsFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotEqualsFailsTrial.class);
		...
		asserts.assertEquals(AssertNotEqualsFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.assert_fails_trials.AssertNotEqualsFailsTrial.testAssertNotEquals(AssertNotEqualsFailsTrial.java:14)", lines.getLine(1));
