...
public abstract class AbstractTestTrial extends SourceFileTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		asserts.assertEquals("org.adligo.tests4j_tests.trials_api.bad_mock_source_file_trials.AbstractTestTrial", 
		...
		asserts.assertEquals("Methods Annotated with @Test must NOT be abstract.", failure.getMessage());
