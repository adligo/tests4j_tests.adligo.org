...
public class AssertNullFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		asserts.assertEquals(new Tests4J_AssertionResultMessages().getTheValueShouldBeNull(), testFailure.getMessage());
		...
		asserts.assertEquals(AssertNullFailsTrial.class.getName(), topElement.getClassName());
