...
public class AssertSameNullFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		runner.run(AssertSameNullFailsTrial.class);
		...
		asserts.assertEquals(AssertSameNullFailsTrial.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertSameNullFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertSameNullFailsTrial.class.getName(), topElement.getClassName());
