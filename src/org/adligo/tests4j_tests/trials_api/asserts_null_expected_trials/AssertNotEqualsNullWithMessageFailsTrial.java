...
public class AssertNotEqualsNullWithMessageFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertNotEqualsNullWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertNotEqualsNullWithMessageFailsTrial.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertNotEqualsNullWithMessageFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertNotEqualsNullWithMessageFailsTrial.class.getName(), topElement.getClassName());
