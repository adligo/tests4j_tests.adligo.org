...
public class AssertContainsNullWithMessageFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertContainsNullWithMessageFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertContainsNullWithMessageFailsTrial.class.getName(), topElement.getClassName());
