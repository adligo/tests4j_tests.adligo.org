...
public class AssertNotEqualsNullWithMessageFailsTrialRunner extends ApiTrial {
	...
	public void testAssertNotEqualsWithMessage() {
		assertNotEquals(TEST_ASSERT_FAILS_MESSAGE, null, null);
	}
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotEqualsNullWithMessageFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertNotEqualsNullWithMessageFailsTrialRunner.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertNotEqualsNullWithMessageFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertNotEqualsNullWithMessageFailsTrialRunner.class.getName(), topElement.getClassName());
