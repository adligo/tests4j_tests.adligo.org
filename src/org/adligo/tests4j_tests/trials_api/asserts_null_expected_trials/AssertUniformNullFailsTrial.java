...
public class AssertUniformNullFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) throws Exception  {
		...
		runner.run(AssertUniformNullFailsTrial.class);
		...
		asserts.assertEquals(AssertUniformNullFailsTrial.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertUniformNullFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertUniformNullFailsTrial.class.getName(), topElement.getClassName());
