...
public class AssertNotEqualsNullFailsTrialRunner {

	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotEqualsNullFailsTrial.class);
		...
		asserts.assertEquals(AssertNotEqualsNullFailsTrialRunner.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertNotEqualsNullFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertNotEqualsNullFailsTrialRunner.class.getName(), topElement.getClassName());
