...
public class AssertThrownUniformNullThrowerFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertThrownUniformNullThrowerFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertThrownUniformNullThrowerFailsTrial.class.getName(), topElement.getClassName());
