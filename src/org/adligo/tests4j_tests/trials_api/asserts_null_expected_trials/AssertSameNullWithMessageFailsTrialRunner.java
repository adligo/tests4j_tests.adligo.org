...
public class AssertSameNullWithMessageFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertSameNullWithMessageFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertSameNullWithMessageFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals("testAssertSameWithMessage", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertSameWithMessage", testResult.getName());
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertSameNullWithMessageFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertSameNullWithMessageFailsTrialRunner.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertSameWithMessage", topElement.getMethodName());
