...
public class AssertSameNullWithMessageFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertSameNullWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertSameNullWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertSameNullWithMessageFailsTrial.testAssertSameWithMessage(AssertSameNullWithMessageFailsTrial.java:16)", lines.getLine(1));
