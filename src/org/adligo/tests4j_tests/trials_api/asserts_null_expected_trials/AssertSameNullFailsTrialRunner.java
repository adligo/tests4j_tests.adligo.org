...
public class AssertSameNullFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertSameNullFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertSameNullFailsTrialRunner.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertSameNullFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertSameNullFailsTrialRunner.class.getName(), topElement.getClassName());
