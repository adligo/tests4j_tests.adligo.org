...
public class AssertNotEqualsNullStringFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertNotEqualsNullStringFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertNotEqualsNullStringFailsTrial.testAssertNotEquals(AssertNotEqualsNullStringFailsTrial.java:14)", lines.getLine(1));
