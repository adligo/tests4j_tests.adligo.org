...
public class AssertNotEqualsNullStringFailsTrialRunner {

	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotEqualsNullStringFailsTrial.class);
		...
		asserts.assertEquals(AssertNotEqualsNullStringFailsTrialRunner.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertNotEqualsNullStringFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertNotEqualsNullStringFailsTrialRunner.class.getName(), topElement.getClassName());
