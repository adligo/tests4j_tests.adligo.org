...
public class AssertNotUniformNullWithMessageFailsTrialRunner {
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertNotUniformNullWithMessageFailsTrial.class);
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertNotUniformNullWithMessageFailsTrial.testAssertNotUniformWithMessage(AssertNotUniformNullWithMessageFailsTrial.java:16)", lines.getLine(1));
