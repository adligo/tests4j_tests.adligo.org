...
public class AssertSameNullWithMessageFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertSameNullWithMessageFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertSameNullWithMessageFailsTrial.class.getName(), topElement.getClassName());
