...
public class AssertContainsNullWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertContainsNullWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertContainsNullWithMessageFailsTrial.testAssertContainsNullFails(AssertContainsNullWithMessageFailsTrial.java:14)", lines.getLine(1));
