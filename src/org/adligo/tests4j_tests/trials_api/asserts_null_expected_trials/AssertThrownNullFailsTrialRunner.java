...
public class AssertThrownNullFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertThrownNullFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertThrownNullFailsTrialRunner.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertThrownNullFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertThrownNullFailsTrialRunner.class.getName(), topElement.getClassName());
