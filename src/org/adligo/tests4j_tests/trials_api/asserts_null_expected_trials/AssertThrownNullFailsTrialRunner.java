...
public class AssertThrownNullFailsTrialRunner {
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertThrownNullFailsTrial.class);
		...
		asserts.assertEquals(AssertThrownNullFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertThrownNullFailsTrial.testAssertThrownNull(AssertThrownNullFailsTrial.java:17)", lines.getLine(1));
