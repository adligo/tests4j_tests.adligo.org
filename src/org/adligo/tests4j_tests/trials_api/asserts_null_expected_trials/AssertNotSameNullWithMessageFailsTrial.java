...
public class AssertNotSameNullWithMessageFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		runner.run(AssertNotSameNullWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertNotSameNullWithMessageFailsTrial.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertNotSameNullWithMessageFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertNotSameNullWithMessageFailsTrial.class.getName(), topElement.getClassName());
