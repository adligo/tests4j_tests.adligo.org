...
public class AssertNotEqualsNullStringWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertNotEqualsNullStringWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertNotEqualsNullStringWithMessageFailsTrial.testAssertNotEqualsWithMessage(AssertNotEqualsNullStringWithMessageFailsTrial.java:16)", lines.getLine(1));
