...
public class AssertUniformNullFailsTrialRunner extends ApiTrial {

	@Test
	public void testAssertUniform() {
		assertUniform(null,"a");
	}
	
	public static void runTestDelegate(I_Asserts asserts) throws Exception  {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertUniformNullFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertUniformNullFailsTrialRunner.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertUniformNullFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertUniformNullFailsTrialRunner.class.getName(), topElement.getClassName());
