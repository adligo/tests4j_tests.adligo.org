...
public class AssertNotUniformNullWithMessageFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertNotUniformNullWithMessageFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertNotUniformNullWithMessageFailsTrial.class.getName(), topElement.getClassName());
