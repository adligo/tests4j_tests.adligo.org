...
public class AssertUniformNullWithMessageFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) throws Exception {
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertUniformNullWithMessageFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertUniformNullWithMessageFailsTrial.class.getName(), topElement.getClassName());
