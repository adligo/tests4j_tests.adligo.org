...
public class AssertThrownUniformNullThrowerFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertThrownUniformNullThrowerFailsTrial.class);
		...
		asserts.assertEquals(AssertThrownUniformNullThrowerFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertThrownUniformNullThrowerFailsTrial.testAssertThrownNull(AssertThrownUniformNullThrowerFailsTrial.java:17)", lines.getLine(1));
