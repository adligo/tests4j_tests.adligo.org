...
public class AssertUniformNullWithMessageFailsTrialRunner {
	
	public static void runTestDelegate(I_Asserts asserts) throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertUniformNullWithMessageFailsTrial.class);
		...
		asserts.assertEquals(AssertUniformNullWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertUniformNullWithMessageFailsTrial.testAssertUniformWithMessage(AssertUniformNullWithMessageFailsTrial.java:16)", lines.getLine(1));
