...
public class AssertUniformNullWithMessageFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) throws Exception {
		...
		runner.run(AssertUniformNullWithMessageFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertUniformNullWithMessageFailsTrialRunner.class.getName(), 
		...
		asserts.assertEquals("testAssertUniformWithMessage", testMeta.getTestName());
		...
		asserts.assertEquals("testAssertUniformWithMessage", testResult.getName());
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertUniformNullWithMessageFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertUniformNullWithMessageFailsTrialRunner.class.getName(), topElement.getClassName());
		asserts.assertEquals("testAssertUniformWithMessage", topElement.getMethodName());
