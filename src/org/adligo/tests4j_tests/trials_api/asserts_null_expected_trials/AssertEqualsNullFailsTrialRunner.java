...
public class AssertEqualsNullFailsTrialRunner  {

	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		ExpectedFailureRunner runner = new ExpectedFailureRunner();
		runner.run(AssertEqualsNullFailsTrial.class);
		...
		asserts.assertEquals(AssertEqualsNullFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertEqualsNullFailsTrial.testAssertEqualsNullFails(AssertEqualsNullFailsTrial.java:14)", lines.getLine(1));
