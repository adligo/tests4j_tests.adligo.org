...
public class AssertNotEqualsNullFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts) {
		...
		asserts.assertEquals(AssertNotEqualsNullFailsTrial.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertNotEqualsNullFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertNotEqualsNullFailsTrial.class.getName(), topElement.getClassName());
