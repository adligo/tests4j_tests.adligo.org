...
public class AssertThrownNullWithMessageFailsTrialRunner extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		runner.run(AssertThrownNullWithMessageFailsTrialRunner.class);
		...
		asserts.assertEquals(AssertThrownNullWithMessageFailsTrialRunner.class.getName(), 
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertThrownNullWithMessageFailsTrialRunner.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertThrownNullWithMessageFailsTrialRunner.class.getName(), topElement.getClassName());
