...
public class AssertThrownNullWithMessageFailsTrialRunner {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		asserts.assertEquals(AssertThrownNullWithMessageFailsTrial.class.getName(), 
		...
		asserts.assertEquals("\tat org.adligo.tests4j_tests.trials_api.asserts_null_expected_trials.AssertThrownNullWithMessageFailsTrial.testAssertThrownNull(AssertThrownNullWithMessageFailsTrial.java:17)", lines.getLine(1));
