...
public class AssertNotEqualsNullStringFailsTrial extends ApiTrial {
	...
	public static void runTestDelegate(I_Asserts asserts)  throws Exception {
		...
		for (int i = 0; i < elements.length; i++) {
			...
			if (AssertNotEqualsNullStringFailsTrial.class.getName().equals(className)) {
				break;
			}
		}
		
		asserts.assertEquals(AssertNotEqualsNullStringFailsTrial.class.getName(), topElement.getClassName());
