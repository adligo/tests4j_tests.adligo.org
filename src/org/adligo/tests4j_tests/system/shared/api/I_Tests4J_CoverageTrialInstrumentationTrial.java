...
@SourceFileScope (sourceClass=I_Tests4J_CoverageTrialInstrumentation.class)
@AllowedReferences (groups=Tests4J_SystemApi_GwtReferenceGroup.class)
public class I_Tests4J_CoverageTrialInstrumentationTrial extends SourceFileCountingTrial {
