...
@SourceFileScope (sourceClass=Tests4J_CoveragePluginParams.class,minCoverage=0.0)
@AllowedDependencies (groups=Tests4J_SystemApi_DependencyGroup.class)
public class Tests4J_CoveragePluginParamsTrial extends SourceFileCountingTrial {
