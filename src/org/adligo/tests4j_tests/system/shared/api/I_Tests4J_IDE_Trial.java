...
import org.adligo.tests4j.system.shared.api.I_Tests4J_IDE;
...
@SourceFileScope (sourceClass=I_Tests4J_IDE.class)
@AllowedReferences (groups=Tests4J_SystemApi_GwtReferenceGroup.class)
public class I_Tests4J_IDE_Trial extends SourceFileCountingTrial {
