...
@SourceFileScope (sourceClass=Tests4J_DelegateProgressMonitor.class,minCoverage=0.0)
@AllowedDependencies (groups=Tests4J_System_DependencyGroup.class)
public class Tests4J_DelegateProgressMonitorTrial extends SourceFileCountingTrial {
