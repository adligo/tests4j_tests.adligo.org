...
import org.adligo.tests4j.system.shared.trials.TrialRunContext;
import org.adligo.tests4j_tests.base_trials.I_CountType;
import org.adligo.tests4j_tests.base_trials.SourceFileCountingTrial;
import org.adligo.tests4j_tests.references_groups.Tests4J_SystemTrials_GwtReferenceGroup;

@SourceFileScope (sourceClass=TrialRunContext.class,minCoverage=0.0)
@AllowedReferences (groups=Tests4J_SystemTrials_GwtReferenceGroup.class)
public class TrialRunContextTrial extends SourceFileCountingTrial {
