...
@SourceFileScope (sourceClass=TrialParamValue_XML_Consumer.class,minCoverage=0.0)
@AllowedReferences (groups=Tests4J_SystemTrials_GwtReferenceGroup.class)
public class TrialParamValue_XML_ConsumerTrial extends SourceFileCountingTrial {
