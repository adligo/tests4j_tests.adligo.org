...
@SourceFileScope (sourceClass=Tests4J_CoverageTrialInstrumentation.class,minCoverage=0.0)
@AllowedDependencies (groups=Tests4J_System_DependencyGroup.class)
public class Tests4J_CoverageTrialInstrumentationTrial extends SourceFileCountingTrial {
