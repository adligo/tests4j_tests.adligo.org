...
import org.adligo.tests4j_tests.models.shared.dependency_groups.gwt.Appendable_2_6_ClassAttributeUseTrial;
...
public class RunSingleTrial {
	...
	public static void main(String [] args) {
		...
		params.addTrial(Appendable_2_6_ClassAttributeUseTrial.class);
		//params.addTrial(ReferenceTrackingClassVisitorTrial.class);
