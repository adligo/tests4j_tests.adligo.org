...
@SourceFileScope (sourceClass=SourceFileTrialResultMutant.class,minCoverage=0.0)
@AllowedReferences (groups=Tests4J_Results_GwtReferenceGroup.class)
public class SourceFileTrialResultMutantTrial extends SourceFileCountingTrial {
