...
@SourceFileScope (sourceClass=SourceFileCoverageDelegator.class,minCoverage=0.0)
@AllowedReferences (groups=Tests4J_Coverage_GwtReferenceGroup.class)
public class SourceFileCoverageDelegatorTrial extends SourceFileCountingTrial {
