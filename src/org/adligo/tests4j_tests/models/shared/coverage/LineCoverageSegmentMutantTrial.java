...
@SourceFileScope (sourceClass=LineCoverageSegmentMutant.class,minCoverage=0.0)
@AllowedDependencies (groups=Tests4J_Coverage_DependencyGroup.class)
public class LineCoverageSegmentMutantTrial extends SourceFileCountingTrial {
