...
public class Tests4J_SystemTrials_DependencyGroup extends Tests4J_DependencyGroup {
	public static final Tests4J_SystemTrials_DependencyGroup INSTANCE = new Tests4J_SystemTrials_DependencyGroup();
	
	private Tests4J_SystemTrials_DependencyGroup() {
		...
		names.addAll(Tests4J_Results_DependencyGroup.INSTANCE.getClassNames());
		
		names.addAll(Tests4J_Metadata_DependencyGroup.INSTANCE.getClassNames());
		
		names.addAll(Tests4J_Asserts_DependencyGroup.INSTANCE.getClassNames());
		
		names.addAll(Tests4J_Output_DependencyGroup.INSTANCE.getClassNames());
