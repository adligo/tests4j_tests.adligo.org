...
public class Tests4J_SystemApi_DependencyGroup extends Tests4J_DependencyGroup {
	public static final Tests4J_SystemApi_DependencyGroup INSTANCE = new Tests4J_SystemApi_DependencyGroup();
	
	private Tests4J_SystemApi_DependencyGroup() {
		...
		names.addAll(Tests4J_SystemTrials_DependencyGroup.INSTANCE.getClassNames());
