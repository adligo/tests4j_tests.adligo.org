...
public class CalledBadMethod_SourceFileTrialRunner {
	...
	public static void assertDependencyResult(I_Asserts asserts,
		...
		asserts.assertEquals(AllowedDependencyFailure.class.getName(), testFailure.getClass().getName());
		
		AllowedDependencyFailure dtf = (AllowedDependencyFailure) testFailure;
