...
implements I_TrialParams<A_CocoDataCmnPkgTrials>, I_CountingPackageTrials {
	...
	public static void main(String [] args) {
		try {
			...
			A_CocoDataCmnPkgTrials me = new A_CocoDataCmnPkgTrials();
			me.setParams(params);
			me.addTrials();
			params.addTrials(me);
	...
	@Override
	public A_CocoDataCmnPkgTrials getTrialParams() {
		return this;
	}
}
