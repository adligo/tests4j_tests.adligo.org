...
public class A_CocoPlugCoverPkgTrials extends SimplePackageTrials 
implements I_TrialParams<A_CocoPlugCoverPkgTrials>, I_CountingPackageTrials {
	...
	public static void main(String [] args) {
		try {
			...
			A_CocoPlugCoverPkgTrials me = new A_CocoPlugCoverPkgTrials();
			me.setParams(params);
			me.addTrials();
			params.addTrials(me);
	...
	public void addTrials() throws Exception {
		add(LazyPackageCoverageFactoryTrial.class);
	}

	@Override
	public A_CocoPlugCoverPkgTrials getTrialParams() {
		return this;
	}
}
