...
import org.adligo.tests4j.run.xml.io.use_cases.v1_0.StepType;
...
@SourceFileScope (sourceClass=StepType.class,minCoverage=0.0)
@AllowedReferences (groups=Tests4J_XmlUseCases_ReferenceGroup.class)
public class StepTypeTrial extends SourceFileCountingTrial {
