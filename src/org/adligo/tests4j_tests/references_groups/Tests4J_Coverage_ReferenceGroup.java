...
import org.adligo.tests4j.models.shared.coverage.I_CoverageIntContainer;
import org.adligo.tests4j.models.shared.coverage.I_CoverageIntContainerMutant;
...
public class Tests4J_Coverage_ReferenceGroup extends Tests4J_ReferenceGroup {
	...
	private Tests4J_Coverage_ReferenceGroup() {
		...
		add(names, I_CoverageIntContainer.class);
		add(names, I_CoverageIntContainerMutant.class);
