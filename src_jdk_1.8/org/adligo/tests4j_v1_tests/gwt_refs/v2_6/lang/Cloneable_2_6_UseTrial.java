...
@SourceFileScope (sourceClass=Cloneable_2_6_MockUse.class)
public class Cloneable_2_6_UseTrial extends SourceFileCountingTrial 
  implements Cloneable {
	...
	public void testMethods() throws Exception {
		new Cloneable_2_6_MockUse(this);
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(Cloneable_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getReferences("java.lang.Cloneable");
		...
		I_ClassAttributes example = GWT_2_6_Lang.getCloneable();
