...
@SourceFileScope (sourceClass=Entry_2_6_MockUse.class)
public class MapEntry_2_6_UseTrial extends SourceFileCountingTrial 
  implements Entry {
	...
	public void testMethods() throws Exception {
		new Entry_2_6_MockUse(this);
		assertEquals(5, methodsCalled);
	}
...
@Override
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(Entry_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getReferences("java.util.Map$Entry");
