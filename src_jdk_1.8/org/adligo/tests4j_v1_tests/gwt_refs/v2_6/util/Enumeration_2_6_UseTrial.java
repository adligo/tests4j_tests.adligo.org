...
@SourceFileScope (sourceClass=Enumeration_2_6_MockUse.class)
public class Enumeration_2_6_UseTrial extends SourceFileCountingTrial 
  implements Enumeration<Object> {
	...
	public void testMethods() throws Exception {
		new Enumeration_2_6_MockUse(this);
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(Enumeration_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getReferences("java.util.Enumeration");
		...
		I_ClassAttributes example = GWT_2_6_Util.getEnumeration();
