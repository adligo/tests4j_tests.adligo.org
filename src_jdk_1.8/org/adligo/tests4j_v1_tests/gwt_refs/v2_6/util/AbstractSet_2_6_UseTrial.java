...
@SourceFileScope (sourceClass=AbstractSet_2_6_MockUse.class)
public class AbstractSet_2_6_UseTrial extends SourceFileCountingTrial {

	@Test
	public void testMethods() throws Exception {
		new AbstractSet_2_6_MockUse(new HashSet());
		assertTrue("The trial should be able to create aAbstractSet_MockUse.",true);
	}
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(AbstractSet_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getReferences("java.util.AbstractSet");
		...
		I_ClassAttributes example = GWT_2_6_Util.getAbstractSet();
