...
@SourceFileScope (sourceClass=I_JSE_1_8_LangAnnot.class)
@AllowedReferences (groups=Tests4J_JSE_v1_8_GwtReferenceGroup.class)
public class I_JSE_1_8_LangAnnotTrial extends SourceFileCountingTrial {

	@Test
	public void testConstants() {
		Class<?> [] classes = I_JSE_1_8_LangAnnot.class.getInterfaces();
		List<Class<?>> cs = Arrays.asList(classes);
		assertContains(cs, I_JSE_1_7_LangAnnot.class);
	}
	@Override
