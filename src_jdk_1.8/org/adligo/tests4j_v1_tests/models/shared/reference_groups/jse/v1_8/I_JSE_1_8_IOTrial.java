...
@SourceFileScope (sourceClass=I_JSE_1_8_IO.class)
@AllowedReferences (groups=Tests4J_JSE_v1_8_GwtReferenceGroup.class)
public class I_JSE_1_8_IOTrial extends SourceFileCountingTrial {

	@Test
	public void testHeirarach() {
		Class<?> [] classes = I_JSE_1_8_IO.class.getInterfaces();
		List<Class<?>> cs = Arrays.asList(classes);
		assertContains(cs, I_JSE_1_7_IO.class);
	}
	@Override
