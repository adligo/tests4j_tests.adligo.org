...
implements I_MetaTrialParams<A_DGroups_GWT_2_6_LangPkgTrials>, I_CountingPackageTrials {
	...
	public void addTrials() throws Exception{
		...
		add(LinkageError_2_6_UseTrial.class);
		add(IncompatibleClassChangeError_2_6_UseTrial.class);
		add(NoSuchFieldError_2_6_UseTrial.class);
	}
