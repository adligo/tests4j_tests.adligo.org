...
@SourceFileScope (sourceClass=Retention_2_6_MockUse.class)
public class Retention_2_6_UseTrial extends SourceFileCountingTrial 
  implements Retention {
	...
	public void testMethods() throws Exception {
		new Retention_2_6_MockUse(this);
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(Retention_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getAttributes("java.lang.annotation.Retention");
		...
		I_ClassAttributes example = GWT_2_6_Annot.getRetention();
