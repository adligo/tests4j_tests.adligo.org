...
@SourceFileScope (sourceClass=AbstractQueue_2_6_MockUse.class)
public class AbstractQueue_2_6_UseTrial extends SourceFileCountingTrial {

	@Test
	public void testMethods() throws Exception {
		new AbstractQueue_2_6_MockUse(new PriorityQueue());
		assertTrue("The trial should be able to create aAbstractQueue_MockUse.",true);
	}
...
@Override
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(AbstractQueue_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getAttributes("java.util.AbstractQueue");
		...
		I_ClassAttributes example = GWT_2_6_Util.getAbstractQueue();
