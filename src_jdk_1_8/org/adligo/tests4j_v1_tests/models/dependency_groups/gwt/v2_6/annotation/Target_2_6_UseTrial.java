...
@SourceFileScope (sourceClass=Target_2_6_MockUse.class)
public class Target_2_6_UseTrial extends SourceFileCountingTrial 
  implements Target {
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(Target_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getAttributes("java.lang.annotation.Target");
		...
		I_ClassAttributes example = GWT_2_6_Annot.getTarget();
