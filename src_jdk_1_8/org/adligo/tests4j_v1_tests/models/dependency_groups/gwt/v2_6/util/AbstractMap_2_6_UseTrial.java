...
@SourceFileScope (sourceClass=AbstractMap_2_6_MockUse.class)
public class AbstractMap_2_6_UseTrial extends SourceFileCountingTrial {

	@Test
	public void testMethods() throws Exception {
		new AbstractMap_2_6_MockUse(new HashMap());
		assertTrue("The trial should be able to create aAbstractMap_MockUse.",true);
	}
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(AbstractMap_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getAttributes("java.util.AbstractMap");
		...
		I_ClassAttributes example = GWT_2_6_Util.getAbstractMap();
