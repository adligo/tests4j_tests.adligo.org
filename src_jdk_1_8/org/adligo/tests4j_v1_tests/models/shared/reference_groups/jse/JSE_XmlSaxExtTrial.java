...
@SourceFileScope (sourceClass=JSE_XmlSaxExt.class,minCoverage=70.0)
@AllowedReferences (groups={Tests4J_JSE_GwtReferenceGroup.class})
public class JSE_XmlSaxExtTrial extends SourceFileCountingTrial {
	public static final int ASSERTS = 15;
	public static final int UASSERTS = 9;
	
	@Test
	public void testSingletonClasses() {
    delegateSingletonClassAsserts(this, JSE_XmlSaxExt.INSTANCE);
    assertEquals("org.xml.sax.ext", JSE_XmlSaxExt.INSTANCE.getPackageName());
    
    Map<String,String> map = JSE_XmlSaxExt.INSTANCE.getModelMap();
