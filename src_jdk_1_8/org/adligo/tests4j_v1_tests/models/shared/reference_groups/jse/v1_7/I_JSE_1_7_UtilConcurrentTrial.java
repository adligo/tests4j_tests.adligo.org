...
@SourceFileScope (sourceClass=I_JSE_1_7_UtilConcurrent.class)
@AllowedReferences (groups=Tests4J_JSE_v1_7_GwtReferenceGroup.class)
public class I_JSE_1_7_UtilConcurrentTrial extends SourceFileCountingTrial {

  @Test
  public void testConstants() {
    Class<?> [] classes = I_JSE_1_7_Util.class.getInterfaces();
    List<Class<?>> cs = Arrays.asList(classes);
    assertContains(cs, I_JSE_1_6_Util.class);
