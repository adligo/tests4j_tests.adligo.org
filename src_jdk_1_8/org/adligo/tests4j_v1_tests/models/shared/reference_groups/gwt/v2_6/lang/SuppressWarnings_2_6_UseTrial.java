...
@SourceFileScope (sourceClass=SuppressWarnings_2_6_MockUse.class)
public class SuppressWarnings_2_6_UseTrial extends SourceFileCountingTrial 
  implements SuppressWarnings {
	...
	public void testMethods() throws Exception {
		new SuppressWarnings_2_6_MockUse(this);
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(SuppressWarnings_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getReferences("java.lang.SuppressWarnings");
		...
		I_ClassAttributes example = GWT_2_6_Lang.getSuppressWarnings();
