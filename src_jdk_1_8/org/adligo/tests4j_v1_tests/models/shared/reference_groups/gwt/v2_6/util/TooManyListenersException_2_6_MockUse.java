...
public class TooManyListenersException_2_6_MockUse {

	public TooManyListenersException obj = null;
	public TooManyListenersException_2_6_MockUse() {
		obj = new TooManyListenersException();
		obj = new TooManyListenersException(
			"string");
		callObjectMethods();
