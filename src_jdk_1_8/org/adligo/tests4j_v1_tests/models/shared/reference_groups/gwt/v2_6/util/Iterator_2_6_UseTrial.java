...
@SourceFileScope (sourceClass=Iterator_2_6_MockUse.class)
public class Iterator_2_6_UseTrial extends SourceFileCountingTrial 
  implements Iterator {
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(Iterator_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getReferences("java.util.Iterator");
		...
		I_ClassAttributes example = GWT_2_6_Util.getIterator();
