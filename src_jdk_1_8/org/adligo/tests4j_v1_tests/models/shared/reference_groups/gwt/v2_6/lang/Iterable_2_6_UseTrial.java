...
@SourceFileScope (sourceClass=Iterable_2_6_MockUse.class)
public class Iterable_2_6_UseTrial extends SourceFileCountingTrial 
  implements Iterable {
...
@Override
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(Iterable_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getReferences("java.lang.Iterable");
		...
		I_ClassAttributes example = GWT_2_6_Lang.getIterable();
