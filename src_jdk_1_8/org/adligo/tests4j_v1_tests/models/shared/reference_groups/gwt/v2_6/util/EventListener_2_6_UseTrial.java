...
@SourceFileScope (sourceClass=EventListener_2_6_MockUse.class)
public class EventListener_2_6_UseTrial extends SourceFileCountingTrial 
  implements EventListener {
	...
	public void testMethods() throws Exception {
		new EventListener_2_6_MockUse(this);
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(EventListener_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getReferences("java.util.EventListener");
		...
		I_ClassAttributes example = GWT_2_6_Util.getEventListener();
