...
@SourceFileScope (sourceClass=RandomAccess_2_6_MockUse.class)
public class RandomAccess_2_6_UseTrial extends SourceFileCountingTrial 
  implements RandomAccess {
	...
	public void testMethods() throws Exception {
		new RandomAccess_2_6_MockUse(this);
	...
	public void afterTrialTests(I_SourceFileTrialResult p) {
		...
		assertEquals(RandomAccess_2_6_MockUse.class.getName(), refs.getName());
		I_ClassAttributes result = p.getAttributes("java.util.RandomAccess");
		...
		I_ClassAttributes example = GWT_2_6_Util.getRandomAccess();
