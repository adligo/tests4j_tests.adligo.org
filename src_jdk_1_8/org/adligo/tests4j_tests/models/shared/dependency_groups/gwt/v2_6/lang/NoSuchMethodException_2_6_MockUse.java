...
public class NoSuchMethodException_2_6_MockUse {

	public NoSuchMethodException obj = null;
	public NoSuchMethodException_2_6_MockUse() {
		obj = new NoSuchMethodException();
		obj = new NoSuchMethodException(
			"string");
		callObjectMethods();
